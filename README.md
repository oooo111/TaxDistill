...
| `--genomeocean` | GenomeOcean dataset to use, e.g., `GenomeOcean/100M`. The GenomeOcean dataset can be downloaded from [Hugging Face](https://huggingface.co/DOEJGI/GenomeOcean-500M) |
